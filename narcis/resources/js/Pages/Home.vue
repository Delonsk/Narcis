                                ...
                                <g>
                                    <g>
                                        ...
                                        <path
                                            ...
                                            style="fill: #f29c1f;"></path>
                                        <circle cx="149.03" cy="148.02" r="13.5" style="fill: #e57e25;"></circle>
                                    </g>
            ...
            <div class="max-w-[1380px] w-full">
                ...
                <section class="pt-[270px] pb-[410px] relative" id="onas">
                    ...
                    <div class="flex justify-center">
                        <div class="relative">
                            <h1 class="text-[75px] font-['grafolita-script'] px-[25px]"><span
                                class="text-[#F0C419]">O</span>
                                Nás
                            </h1>
                    ...
                    <div class="justify-center flex pt-[70px] relative">
                        <p class="w-11/12 px-[10px] text-center font-['ff-scala-sans-pro'] text-[28px] md:text-[40px] leading-[56px] ">
                            ...
                            gratulačných, svadobných aj smútočných kytíc a vencov. Aranžujeme živé aj umelé dekorácie do
                            bytov
                            aj na hroby. U nás si môžete objednať aj výzdoby kostolov a svadobných sál. Rozvoz
                            donáškových
                            kytíc
                            v rámci Bardejova
                ...
                <section class="" id="kontakt">
                    ...
                    <div class="lg:pt-[140px] pt-[70px]   lg:flex ">
                        <div class="lg:w-1/2 px-[40px] md:px-[80px]">
                            ...
                            <div
                                class="pt-[25px] font-['grafolita-script'] text-[36px] justify-center lg:justify-start flex">
                                <div class="">
                                    <div class="flex justify-center lg:justify-start">
                        ...
                        <div class="w-full lg:w-1/2 pt-[120px] flex flex-col items-center lg:items-start">
                            ...
                            <div class="font-['grafolita-script']  text-[36px] md:w-[375px]">
                                <div class="flex justify-between pt-[25px]">
                                    ...
                                    <p class="text-[#F0C419] w-[180px]">8:00 - 16:30</p>
                                </div>
                                ...
                                <div class="flex justify-between pt-[19px]">
                                    ...
                                    <p class="text-[#F0C419] w-[180px]">9:00 - 12:00</p>
                                </div>
                                <div class="flex justify-between pt-[19px]">
                                    <p class="pr-[10px]">Nedeľa</p>
                                    <p class="text-[#F0C419] w-[180px]">Zatvorené</p>
                                </div>
